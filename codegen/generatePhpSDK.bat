...
java -jar swagger-codegen-cli-2.4.5.jar generate -i ..\spec\asposeforcloud_cad_without_disciminator.json -l php -t Templates\php -c phpConfig.json -o "%tmpfolder%" --invoker-package Aspose\CAD --model-package Model --api-package Api || goto :error
...
xcopy "%tmpfolder%\SwaggerClient-php\lib\Configuration.php" "%sdkfolder%\src\Aspose\CAD" /Y || goto :error

xcopy "%tmpfolder%\SwaggerClient-php\README.md" "%sdkfolder%\README.md" /Y || goto :error
xcopy "%tmpfolder%\SwaggerClient-php\composer.json" "%sdkfolder%\composer.json" /Y || goto :error