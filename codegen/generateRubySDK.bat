...
java -jar codegen\swagger-codegen-cli-2.3.0.jar generate -i spec\asposeforcloud_cad_without_disciminator.json -l ruby -t codegen\Templates\ruby -o c:/tmp/ruby/ -c codegen\rubyConfig.json || goto :error
