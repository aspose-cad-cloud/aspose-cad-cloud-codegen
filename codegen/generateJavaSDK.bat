...
java -jar codegen\swagger-codegen-cli-2.3.0.jar generate -i spec\asposeforcloud_word_without_disciminator.json -l java -t codegen\Templates\java -o c:/tmp/java/ -c codegen\javaConfig.json || goto :error
