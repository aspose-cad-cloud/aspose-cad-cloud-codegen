...
java -jar SDKs\codegen\swagger-codegen-cli-2.3.0.jar generate -i spec\asposeforcloud_word.json -l csharp -t SDKs\codegen\Templates\csharp -o c:/tmp/csharp/ -c SDKs\codegen\config.json || goto :error
...
java -jar SDKs\codegen\swagger-codegen-cli-2.3.0.jar generate -i spec\asposeforcloud_word.json -l php -t SDKs\codegen\Templates\php -o c:/tmp/php/ --invoker-package Aspose\Words --model-package Model --api-package Api || goto :error
